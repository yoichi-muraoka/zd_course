...
if($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  try {
    add_question($examId, $num, $sentence, $answer, $rightAnswer, $score);
...
<div class="container admin-container">
  <main>
    <form action="" method="post">
      ...
      <p>問題文:<br>
        <textarea name="sentence" class="w-100 h-10em lh-1"></textarea>
      </p>
      <p>解答欄:<br>
        <textarea name="answer" class="w-100 h-10em lh-1"></textarea>
      </p>
      <p>正答:
        <input type="text" name="right_answer" class="w-100">
      </p>
      <p>
        <input type="submit" class="btn btn-primary" value="登録">
        <a href="examPreview.php?exam_id=<?php echo $examId; ?>" class="btn btn-success">キャンセル</a>
      </p>
    </form>
  </main>
</div>
